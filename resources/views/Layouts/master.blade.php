			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<div class="site-logo">
							<a href="/">
								<img src="{{ asset('assets/img/logo.png') }}" alt="" style="margin-top: -1rem;">
							</a>
						</div>
						<!-- logo -->
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2025 - <a href="https://imransdesign.com/">Imran Hossain</a>,  All Rights Reserved.<br>
